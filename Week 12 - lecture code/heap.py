...
def namecmp(n1, n2):
    ...
    Sort the names in alphabetical ascending order
    :param n1: Name
    :param n2: Other name
...
def test2():
    ...
    for num in (4, 6, 10, 2, -1, 3):
        maxh.insert(num)
    print("Array contents:", maxh.data)
...
def main():
    # testing a min-heap with numerical values
    test1()

    # testing a max-heap with numerical values
    test2()

    # testing a mix-heap of names (alphabetical ascending order by last name)
    test3()
